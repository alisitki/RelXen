...
Keep MAINNET auto idle; next work is operator review of the hardened state and a fresh explicit precheck before any separate operator-approved live run.
