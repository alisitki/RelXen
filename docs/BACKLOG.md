...
Run a disabled-live-auto market-data runtime smoke focused on the Binance kline stream, then add or confirm watchdog-level market-data freshness stopping before any further real MAINNET auto run.
